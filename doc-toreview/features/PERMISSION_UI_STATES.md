...
- [Permission-Aware UI States](#permission-aware-ui-states)
  - [Overview](#overview)
  - [Key Features](#key-features)
  - [Core Components](#core-components)
    - [1. PermissionGatingUtil Class](#1-permissiongatingutil-class)
    - [2. usePermissionGating Hook](#2-usepermissiongating-hook)
    - [3. PermissionGatingExample Component](#3-permissiongatingexample-component)
  - [Permission Scopes](#permission-scopes)
  - [Usage Patterns](#usage-patterns)
    - [Gating Buttons](#gating-buttons)
    - [Gating Form Fields](#gating-form-fields)
    - [Gating Entire Elements](#gating-entire-elements)
  - [Error Handling](#error-handling)
    - [403 Redirects](#403-redirects)
    - [Toast Notifications](#toast-notifications)
  - [Middleware Integration](#middleware-integration)
  - [Best Practices](#best-practices)
  - [Migration Guide](#migration-guide)
    - [Before (Manual checks)](#before-manual-checks)
    - [After (Gating utilities)](#after-gating-utilities)
  - [Testing](#testing)
