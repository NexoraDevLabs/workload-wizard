...
- [PostHog Integration (Proxy, Flags, Early Access, Session Replays & Heatmaps)](#posthog-integration-proxy-flags-early-access-session-replays--heatmaps)
  - [Overview](#overview)
  - [Next.js rewrites (`next.config.ts`)](#nextjs-rewrites-nextconfigts)
  - [Client instrumentation policy (`instrumentation-client.ts`)](#client-instrumentation-policy-instrumentation-clientts)
  - [Enhanced Analytics Service (`src/lib/analytics.ts`)](#enhanced-analytics-service-srclibanalyticsts)
  - [Environment variables](#environment-variables)
  - [Feature flags](#feature-flags)
  - [Early Access Features (EAF)](#early-access-features-eaf)
  - [Session Recordings & Heatmaps](#session-recordings--heatmaps)
...
- Feature flags and Early Access Features (EAF) have been removed from this project
