...
- [📖 Permission System Guide](./docs/dev/PERMISSIONS.md) - Complete documentation
- [🔍 Audit Logging Guide](./docs/dev/AUDIT.md) - Audit system
- [👥 User Management](./docs/dev/USER_MANAGEMENT.md) - User features
- [⚙️ Permission UI States](./docs/dev/PERMISSION_UI_STATES.md) - UI configuration
