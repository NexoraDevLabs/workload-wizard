...
type CaptureContext = { componentStack?: string | undefined; contextTag?: string | undefined; extras?: Record<string, unknown> };

export function captureUIException(error: unknown, ctx: CaptureContext = {}): void {
  // Guard unknown → Error
