...
function benchmark(name: string, fn: () => void | Promise<void>, iterations = 1000): Promise<BenchmarkResult> {
...
async function runBenchmarks(): Promise<void> {
  ...
  results.push(await benchmark('String operations', () => {
